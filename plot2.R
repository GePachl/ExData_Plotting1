      ...
      # Task 2: Creating plot2.r and plot2.png about "Global_active_power consumption/usage for days 2007-02-01 (Thu), 2007-02-02 (Fri)" 
      ...
      plot(hh_power_consumption$Global_active_power~hh_power_consumption$Date_time, type="l",
